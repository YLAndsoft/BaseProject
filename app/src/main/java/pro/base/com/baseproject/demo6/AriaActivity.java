...
public class AriaActivity extends BaseActivity implements DownloadOnClickListener {
            ...
            public void onResponse(String result) {
                    if(result!=null){
                        ...
                        if(newGameAppTypeViews!=null&&newGameAppTypeViews.size()>0){
                            mAdapter = new AriaAdapter(mContext,AriaActivity.this);
            ...
            switch (taskState){
                ...
                case IEntity.STATE_COMPLETE://完成状态
                    ...
                    if(AppManageUtils.validateSdcardHasAPK(app)){  //文件是否下载完成，并且完整
                        //安装
                        String s = AppManageUtils.installApp(app.getAppApkUrl(), AriaActivity.this);
                        if(s!=null&&!s.equals("")){
                            showToast(s);
                        }
                    }else{
