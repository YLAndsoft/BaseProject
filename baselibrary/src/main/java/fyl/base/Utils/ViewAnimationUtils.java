...
public class ViewAnimationUtils {
     ...
     *
     * @param view              被处理的视图
     * @param isBanClick        在执行动画的过程中是否禁止点�?
     * @param durationMillis    持续时间，毫�?
    ...
    public static void goneViewByAlpha(final View view, long durationMillis, final boolean isBanClick, final AnimationListener animationListener) {
        if (view.getVisibility() != View.GONE) {
            ...
            //hiddenAlphaAnimation.setFillAfter(true);
           // hiddenAlphaAnimation.setFillBefore(false);
            view.startAnimation(hiddenAlphaAnimation);
        }
    }
     ...
     *
     * @param view           要移动的视图
     * @param fromXDelta     X轴开始坐�?
     * @param toXDelta       X轴结束坐�?
     * @param fromYDelta     Y轴开始坐�?
     * @param toYDelta       Y轴结束坐�?
     * @param cycles         重复
